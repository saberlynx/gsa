...
const advancedWizardAlertInput = startDate => {
  return {
    input: {
...
export const createAdvancedWizardAlertQueryMock = (
  startDate = mockDate,
  errors,
) =>
  createGenericQueryMock(
    CREATE_ALERT,
    createAlertResult,
    advancedWizardAlertInput(startDate),
    errors,
  );

const advancedWizardScheduleInput = {
  input: {
...
export const createAdvancedWizardScheduleQueryMock = () =>
  createGenericQueryMock(
    CREATE_SCHEDULE,
    createScheduleResult,
    advancedWizardScheduleInput,
  );

const advancedWizardTargetInput = startDate => {
  return {
    input: {
      name: `Target for myFirstTask - ${startDate.toISOString()}`,
      hosts: '127.0.0.1, 192.168.0.1',
      portListId: ALL_IANA_ASSIGNED_TCP,
...
export const createAdvancedWizardTargetQueryMock = (startDate = mockDate) =>
  createGenericQueryMock(
    CREATE_TARGET,
    createTargetResult,
    advancedWizardTargetInput(startDate),
  );

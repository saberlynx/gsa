...
export const createAdvancedWizardAlertQueryMock = (startDate, errors) =>
  createGenericQueryMock(
    CREATE_ALERT,
    createAlertResult,
...
const advancedWizardTargetInput = {
  input: {
    name: 'Target for myFirstTask - 2019-04-07T11:13:30.000Z',
    hosts: '127.0.0.1, 192.168.0.1',
    portListId: ALL_IANA_ASSIGNED_TCP,
